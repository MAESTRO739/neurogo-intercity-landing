  ...
  return (
    <div ref={wrapRef} className={`relative ${className || ''}`}>
      ...
      <input
        ...
        onKeyDown={handleKey}
        className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent focus:outline-none hover:border-violet-500"
      />
